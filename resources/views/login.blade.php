				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#home" role="tab">
							<svg class="olymp-login-icon"><use xlink:href="{{ secure_asset('template/app/svg-icons/sprites/icons.svg#olymp-login-icon')}}"></use></svg>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#profile" role="tab">
							<svg class="olymp-register-icon"><use xlink:href="{{ secure_asset('template/app/svg-icons/sprites/icons.svg#olymp-register-icon')}}"></use></svg>
						</a>
					</li>
				</ul>
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<div class="form-group date-time-picker label-floating">
										...
										<span class="input-group-addon">
														<svg class="olymp-calendar-icon"><use xlink:href="{{ secure_asset('template/app/svg-icons/sprites/icons.svg#olymp-calendar-icon')}}"></use></svg>
													</span>
									</div>
